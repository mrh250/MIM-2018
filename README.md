# MIM 2018 Conference Application

This is the companion app for the MIM 2018 conference, which is based on the official Ionic demo app, showcasing a variety of Ionic Framework components and native features.
...
* Clone this repository: `git clone https://github.com/mrh250/MIM-2018.git`.
...
* PWA - Un-comment [this](https://github.com/mrh250/MIM-2018/blob/master/src/index.html#L21), run `npm run ionic:build --prod` and then push the `www` folder to your favorite hosting service
